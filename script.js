...
let citationAffiche = document.querySelector("#citation");
let auteurAffiche = document.querySelector("#auteur");
...
nouveau.addEventListener("click",() => {
    ...
    } while (nombreAleatoire == indexCitationAffiche);
    indexCitationAffiche = nombreAleatoire;
    citationAffiche.textContent = citations[indexCitationAffiche][0];
    auteurAffiche.textContent = citations[indexCitationAffiche][1];
});
